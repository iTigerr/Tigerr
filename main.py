...
async def on_message(message):
  ...
  if msg.startswith("T!image "):
    #try:
    emb = discord.Embed(title=str(message.author), description="Image generated by OpenAI DALL-E", color=MAIN)
    emb.set_image(url=functions.image(message))
